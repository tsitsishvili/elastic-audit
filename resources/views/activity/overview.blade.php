...
@include('elastic-audit::partials.overview-controls', [
    'action' => route('activity-logs.overview', [], false),
    'idPrefix' => 'activity-overview',
    'range' => $range,
    'ranges' => $ranges,
    'interval' => $interval,
    'intervals' => $intervals,
    'timezone' => $timezone,
    'liveKey' => 'tphl_live_activity_overview',
])
...
@push('scripts')
    @if ($hasData)
        <script type="module" src="{{ asset('vendor/elastic-audit/' . $elasticAuditAssets['resources/js/chart.js']['file']) }}"></script>
        <script type="module">
            (function () {
